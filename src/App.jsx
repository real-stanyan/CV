...
function App() {
  ...
  useEffect(() => {
    ...
    const animate = function () {
      ...
      if (loadedModel) {
        ...
        gsap.to(loadedModel.rotation, { x: 0, duration: 4, delay: 3 });
      }
  ...
  return (
    ...
    >
      ...
      <div
        id="intro_slide"
        className="w-full h-full flex flex-col items-center lg:flex-row absolute top-[100vh] left-0 p-4 lg:p-8"
      >
        <div className="w-full lg:w-[20%] flex flex-col justify-center items-center lg:items-start text-[6vw] lg:text-[2vw] text-[#f5f5f5] whitespace-nowrap font-IBM font-[400]">
          <h1>I'm Stan Yan.</h1>
        ...
        />
        <div className="w-full flex-1 lg:w-[20%] grid grid-cols-2 gap-3 lg:flex lg:flex-col font-IBM">
          {/* My Github */}
          <div
            onClick={() =>
